  ...
  return (
    <div className="flex flex-col items-end mt-3 gap-6 w-full">
      ...
      <div className="w-full md:w-[20rem] border border-light-gray rounded-xl p-3 shadow-sm">
        ...
        <div className="flex justify-between text-sm border-t font-medium border-light-gray pt-3 text-[#AFB1AE] mb-2">
          <span>Shipping:</span>
          <span>Calculate on checkout</span>
        </div>

        <div className="flex justify-between text-sm font-semibold text-[#AFB1AE] mt-3 border-t border-light-gray pt-2">
          <span>Total:</span>
          <span>¥{Number(subtotal).toLocaleString()}</span>
        </div>
