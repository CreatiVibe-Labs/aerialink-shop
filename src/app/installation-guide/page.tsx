...
const Page = () => {
	return (
		<div className="max-w-7xl mx-auto  my-5">
			<h1 className="text-[40px] max-sm:text-[32px] font-bold text-[#AFB1AE] mb-8 max-sm:mb-5">Installation Guide</h1>

			<section className="mb-10">
				<h2 className="text-3xl max-sm:text-2xl font-semibold mb-4 text-[#AFB1AE]">What you need to know before purchase</h2>
				<ul className="list-disc pl-6 space-y-2 text-[#AFB1AE] text-[20px] max-sm:text-[16px]">
			...
			<section className="mb-10">
				<InstallationDiagram />
				<h2 className="text-3xl max-sm:text-2xl font-semibold mb-4 text-[#AFB1AE]">About Installation of Carpets</h2>
                <ul className="list-disc pl-6 space-y-2 text-[#AFB1AE] text-[20px] max-sm:text-[16px]">
			...
			<section className="mb-10">
				<h2 className="text-3xl max-sm:text-2xl font-semibold mb-4 text-[#AFB1AE]">Precautions for Using Carpet</h2>
				<ul className="list-disc pl-6 space-y-2 text-[#AFB1AE] text-[20px] max-sm:text-[16px]">
