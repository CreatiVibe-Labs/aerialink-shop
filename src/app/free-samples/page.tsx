...
const Page = () => {
  return (
    <div className="max-w-7xl mx-auto  my-10">
      <h1 className="text-[40px] max-sm:text-[32px] font-bold text-[#AFB1AE] mb-3">Free Samples</h1>
      <p className="text-[#AFB1AE] text-[20px] max-sm:text-[16px] mb-4">
      ...
      <p className="text-[#AFB1AE] max-sm:text-[16px] text-[20px] mb-4">
      ...
      <p className="text-[#AFB1AE] text-[20px] max-sm:text-[16px] mb-6">
