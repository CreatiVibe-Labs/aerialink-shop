...
const Page = () => {
  return (
    <div className="max-w-7xl mx-auto  my-10">
      <h1 className="text-[40px] font-bold text-[#666664] mb-3">Free Samples</h1>
      <p className="text-[#666664] text-[20px] mb-4">
      ...
      <h2 className="text-2xl font-semibold text-[#666664] mt-10 mb-4">Sample Request</h2>
      <p className="text-[#666664] text-[20px] mb-6">
      ...
      {/* <div className="bg-gray-50 border rounded p-6 ">
        <h3 className="text-xl text-[#666664] font-semibold mb-3">Request Form (Coming Soon)</h3>
        <p className="text-[#666664] text-[20px] mb-4">We will add an interactive form here for submitting your sample request.</p>
