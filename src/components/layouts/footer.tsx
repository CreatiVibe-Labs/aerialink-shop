    ...
    <footer className="w-full bg-white py-10 sm:py-5">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start text-center md:text-left"> 
          {/* Logo + Description */}
          <div>
            <Image src={'/assets/common/ecommerce-logo.png'} width={100} height={100} alt="Aerialink" className="xl:w-18 xl:h-18 xl:mr-auto lg:w-12 lg:h-12 lg:mr-auto md:w-10 md:h-10 h-12 w-12 md:mr-auto object-contain text-center items-start  sm:items-center sm:mx-auto " />
