...
const InfoBanner = () => {
  return (
    <div className="rounded-2xl  border  border-gray-200 bg-[#EBECF0] p-10 max-2xl:p-3 shadow-sm overflow-hidden">
      <div className="grid grid-cols-2 gap-2 items-center min-h-[25rem] max-2xl:min-h-[10rem]  rounded-xl bg-[url('/assets/home/texture.png')] bg-center bg-cover">
        {/* Left side image */}
        ...
        {/* Right side text */}
        <div className="p-2 pr-3 space-y-2 max-sm:space-y-1 text-light-gray">
